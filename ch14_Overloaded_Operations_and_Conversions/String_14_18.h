#ifndef CH14_OVERLOADED_OPERATIONS_AND_CONVERSIONS_STRING_14_18_H_
#define CH14_OVERLOADED_OPERATIONS_AND_CONVERSIONS_STRING_14_18_H_
#include <iostream>
#include <utility>
#include <memory>
class String {
...
bool operator<(const String &lhs, const String &rhs);
bool operator>(const String &lhs, const String &rhs);
#endif  // CH14_OVERLOADED_OPERATIONS_AND_CONVERSIONS_STRING_14_18_H_