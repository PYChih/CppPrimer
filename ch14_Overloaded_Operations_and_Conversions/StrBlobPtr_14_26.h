#ifndef CH14_OVERLOADED_OPERATIONS_AND_CONVERSIONS_STRBLOBPTR_14_26_H_
#define CH14_OVERLOADED_OPERATIONS_AND_CONVERSIONS_STRBLOBPTR_14_26_H_
#include <string>
#include <vector>
...
bool operator<(const StrBlob &lhs, const StrBlob &rhs);
bool operator>(const StrBlob &lhs, const StrBlob &rhs);
#endif  // CH14_OVERLOADED_OPERATIONS_AND_CONVERSIONS_STRBLOBPTR_14_26_H_