// Exercise 12.17:
//  Which of the following unique_ptr
//  declarations are illegal or likely toresult
//  in subsequent program error?
...
int main() {
    ...
    // IntP p0(ix);  // illegal
    // b
    // IntP p1(pi);  // the object is not allocate using new.
    // c
